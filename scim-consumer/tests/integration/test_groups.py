...
@pytest.mark.asyncio
async def test_create_group(scim_client):
    #
    # Create Group
    #
...
@pytest.mark.asyncio
async def test_update_group(scim_client):
    #
    # Create Group
    #
    pm = get_provisioning_message("group_create")
...
@pytest.mark.asyncio
async def test_delete_group(scim_client):
    #
    # Create Group
    #
    pm = get_provisioning_message("group_create")
...
@pytest.mark.asyncio
async def test_add_group_member(scim_client, mocker):
    #
    # Create User
    #
    pm_user = get_provisioning_message("user_create")
    await handle_udm_message(pm_user)
    ...
    await handle_udm_message(pm_group)
...
@pytest.mark.asyncio
async def test_remove_group_member(scim_client, mocker):
    #
    # Create User
    #
    pm_user = get_provisioning_message("user_create")
