...
from scim2_models import Resource, User
...
class TestCrudUdm(Generic[T], CrudScim[T]):
    """
    ...
    def __init__(
        ...
        """
        Initialize the test UDM CRUD implementation.
        Args:
        ...
        self.logger.info("Initialized Test UDM CRUD.")
    ...
    async def create(self, resource: T) -> T:
        ...
        resource.meta["resource_type"] = self.resource_type
        resource.meta["location"] = f"{self.udm_url}/{self.resource_type}s/{resource.id}"
