...
* **deps:** Update gitregistry.knut.univention.de/univention/dev/projects/ucs-base-image/ucs-base-python Docker tag to v5.2.4-build.20260224 ([4cfce22](https://git.knut.univention.de/univention/dev/projects/scim/scim-services/commit/4cfce225d321293559c8f93343f4af93e2fe38d5)), closes [#0](https://git.knut.univention.de/univention/dev/projects/scim/scim-services/issues/0)
...
* Bump image to errata 299 ([c18e0af](https://git.knut.univention.de/univention/dev/projects/scim/scim-services/commit/c18e0af4724f4d2b09a8d5958f5788831e1f8249)), closes [univention/dev/internal/team-nubus#1518](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1518)
...
* **deps:** Update gitregistry.knut.univention.de/univention/dev/projects/ucs-base-image/ucs-base-python Docker tag to v5.2.3-build.20251030 ([8c0b9a3](https://git.knut.univention.de/univention/dev/projects/scim/scim-services/commit/8c0b9a3d5f7862c766278e1201b3445dc174f51a)), closes [#0](https://git.knut.univention.de/univention/dev/projects/scim/scim-services/issues/0)
