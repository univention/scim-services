...
def get_provisioning_message_data(data_type: str) -> dict[str, Any] | None:
    ...
    group_create = {
        "body": {
            "new": {
                "dn": "cn=Test Users,cn=groups,dc=univention-organization,dc=intranet",
                "id": "Test Users",
                ...
                "properties": {
                    ...
                    "sambaPrivileges": [],
                    "sambaRID": 513,
                    "univentionObjectIdentifier": "eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee",
                    "univentionSourceIAM": None,
                    "users": [],
                },
        ...
        "topic": "groups/group",
        "ts": datetime.datetime(2025, 6, 1, 12, 0, 0, 0),
    }
    ...
    group_update = {
        ...
        "topic": "groups/group",
        "ts": datetime.datetime(2025, 6, 2, 12, 0, 0, 0),
    }
    ...
    group_delete = {
        ...
        "topic": "groups/group",
        "ts": datetime.datetime(2025, 6, 3, 12, 0, 0, 0),
    }
