...
| -                                                  | -        | -                        | emails. display                            | optional | string                                         |          |              | 1  | -    |
| -                                                  | -        | -                        | emails. type                               | optional | string ("work", "home", "other", ...)          |          |              | 1  | -    |
| - (→ mailPrimaryAddress)                           | optional | string                   | emails. primary                            | optional | boolean                                        |          |              | 1  | -    |
...
| guardianRoles                                      | optional | list of strings          | roles. value                               | -        | -                                              |          | (*1) (*19)   | 2  | -    |
| guardianInheritedRoles                             | optional | list of strings          | roles. value (merge)                       | -        | -                                              |          | (*1) (*19)   | 2  | -    |
...
| locale (*22)                                       | optional | string (*13)             | locale                                     | optional | string (*13)                                   | 4.1.1    | (*1)         | 2  | -    |
...
| PasswordRecoveryEmail                              | optional | string                   | Uni:User .passwordRecoveryEmail            | -        | -                                              |          | (*1)         | 2  | -    |
